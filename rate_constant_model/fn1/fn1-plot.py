...
ax1.plot(experiment_273[1,:],(experiment_273[0,:]),'o',color='#ff7f0e',label = r'Model D')
ax1.plot(data_273[1,:],data_273[0,:],'-',color='#1f77b4',label = r'Simulation')
...
ax2.plot(temp,np.array([lifetime_273[0,1],lifetime_296[0,1],lifetime_303[0,1],lifetime_313[0,1],lifetime_333[0,1],lifetime_353[0,1]]),label=r'Simulation')
...
ax2.plot(temp,np.array([lifetime_marcus_273[0,1],lifetime_marcus_296[0,1],lifetime_marcus_303[0,1],lifetime_marcus_313[0,1],lifetime_marcus_333[0,1],lifetime_marcus_353[0,1]]),'--',label=r'Marcus-Hush')
