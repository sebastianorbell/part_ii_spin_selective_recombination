...
marcus_270 = np.loadtxt('dat_pe1p_marcus_270.txt',delimiter=',')
data_290 = np.loadtxt('dat_pe1p_290.txt',delimiter=',')
experiment_290 = np.loadtxt('experimental_pe1p_290.txt',delimiter=',')
marcus_290 = np.loadtxt('dat_pe1p_marcus_290.txt',delimiter=',')
data_296 = np.loadtxt('dat_pe1p_296.txt',delimiter=',')
experiment_296 = np.loadtxt('experimental_pe1p_296.txt',delimiter=',')
marcus_296 = np.loadtxt('dat_pe1p_marcus_296.txt',delimiter=',')
data_310 = np.loadtxt('dat_pe1p_310.txt',delimiter=',')
experiment_310 = np.loadtxt('experimental_pe1p_310.txt',delimiter=',')
marcus_310 = np.loadtxt('dat_pe1p_marcus_310.txt',delimiter=',')
data_330 = np.loadtxt('dat_pe1p_330.txt',delimiter=',')
experiment_330 = np.loadtxt('experimental_pe1p_330.txt',delimiter=',')
marcus_330 = np.loadtxt('dat_pe1p_marcus_330.txt',delimiter=',')
data_350 = np.loadtxt('dat_pe1p_350.txt',delimiter=',')
experiment_350 = np.loadtxt('experimental_pe1p_350.txt',delimiter=',')
marcus_350 = np.loadtxt('dat_pe1p_marcus_350.txt',delimiter=',')

lifetime_marcus_270 =  np.loadtxt('lifetime_pe1p_marcus_270.txt',delimiter=',')
lifetime_marcus_290 =  np.loadtxt('lifetime_pe1p_marcus_290.txt',delimiter=',')
lifetime_marcus_296 =  np.loadtxt('lifetime_pe1p_marcus_296.txt',delimiter=',')
lifetime_marcus_310 =  np.loadtxt('lifetime_pe1p_marcus_310.txt',delimiter=',')
lifetime_marcus_330 =  np.loadtxt('lifetime_pe1p_marcus_330.txt',delimiter=',')
lifetime_marcus_350 =  np.loadtxt('lifetime_pe1p_marcus_350.txt',delimiter=',')
...
ax1.plot(experiment_270[1,:],(experiment_270[0,:]),'o',color='#ff7f0e',label = r'Model D')
ax1.plot(data_270[1,:],data_270[0,:],'-',color='#1f77b4',label = r'Simulation')
ax1.plot(marcus_270[1,:],marcus_270[0,:],'--',color='#2ca02c',label = r'Model H')
...
ax2.plot(marcus_290[1,:],marcus_290[0,:],'--',color='#2ca02c')
...
ax3.plot(marcus_296[1,:],marcus_296[0,:],'--',color='#2ca02c')
...
ax4.plot(marcus_310[1,:],marcus_310[0,:],'--',color='#2ca02c')
...
ax5.plot(marcus_330[1,:],marcus_330[0,:],'--',color='#2ca02c')
...
ax6.plot(marcus_350[1,:],marcus_350[0,:],'--',color='#2ca02c')
...
fig.savefig("pe1p_exp.pdf",bbox_inches='tight', pad_inches=0.2,dpi = 200)
...
ax1.plot(temp,np.array([lifetime_marcus_270[2,0],lifetime_marcus_290[2,0],lifetime_marcus_296[2,0],lifetime_marcus_310[2,0],lifetime_marcus_330[2,0],lifetime_marcus_350[2,0]]),'o-')
ax1.plot(temp,np.array([lifetime_marcus_270[0,0],lifetime_marcus_290[0,0],lifetime_marcus_296[0,0],lifetime_marcus_310[0,0],lifetime_marcus_330[0,0],lifetime_marcus_350[0,0]]),'--')
...
ax2.plot(temp,np.array([lifetime_marcus_270[2,1],lifetime_marcus_290[2,1],lifetime_marcus_296[2,1],lifetime_marcus_310[2,1],lifetime_marcus_330[2,1],lifetime_marcus_350[2,1]]),'o-',label=r'Experiment')
ax2.plot(temp,np.array([lifetime_marcus_270[0,1],lifetime_marcus_290[0,1],lifetime_marcus_296[0,1],lifetime_marcus_310[0,1],lifetime_marcus_330[0,1],lifetime_marcus_350[0,1]]),'--',label=r'Model H')
...
ax3.plot(temp,np.array([lifetime_marcus_270[2,2],lifetime_marcus_290[2,2],lifetime_marcus_296[2,2],lifetime_marcus_310[2,2],lifetime_marcus_330[2,2],lifetime_marcus_350[2,2]]),'o-')
ax3.plot(temp,np.array([lifetime_marcus_270[0,2],lifetime_marcus_290[0,2],lifetime_marcus_296[0,2],lifetime_marcus_310[0,2],lifetime_marcus_330[0,2],lifetime_marcus_350[0,2]]),'--')
ax3.legend(loc='upper left',frameon=False,fontsize=12)
ax3.grid()


fig.savefig("pe1p_lifetime.pdf",bbox_inches='tight', pad_inches=0.2,dpi = 200)
