...
# -*- coding: utf-8 -*-
"""
Created on Fri Jun  7 15:56:37 2019
...
# -*- coding: utf-8 -*-
"""
Created on Wed Jun  5 14:43:30 2019
...
def errorplot():
    ...
    temp = 273.0
    dat = np.loadtxt('pep_t_270_new.txt',delimiter=',') 
    ...
    plt.plot(field,fit_func,color = 'red')
    plt.fill_between(field, rty - 2.0*sigma,rty + 2.0*sigma,color = 'red', alpha=0.4)
    #plt.plot(field,rty,'o')
    ...
    temp = 296.0
    dat = np.loadtxt('pep_t_290_new.txt',delimiter=',')
    field = np.reshape(dat[:,0],(len(dat[:,0])))
    data_y = np.reshape(dat[:,1],(len(dat[:,1])))
    rty = np.arcsinh(data_y-data_y[0]+1.0)    
    ...
    temp = 303.0
    dat = np.loadtxt('pep_t_296_new.txt',delimiter=',')
    field = np.reshape(dat[:,0],(len(dat[:,0])))
    data_y = np.reshape(dat[:,1],(len(dat[:,1])))
    rty = np.arcsinh(data_y-data_y[0]+1.0)    
    ...
    temp = 313.0
    dat = np.loadtxt('pep_t_310_new.txt',delimiter=',')
    field = np.reshape(dat[:,0],(len(dat[:,0])))
    data_y = np.reshape(dat[:,1],(len(dat[:,1])))
    rty = np.arcsinh(data_y-data_y[0]+1.0)   
    ...
    temp = 333.0
    dat = np.loadtxt('pep_t_330_new.txt',delimiter=',')
    field = np.reshape(dat[:,0],(len(dat[:,0])))
    data_y = np.reshape(dat[:,1],(len(dat[:,1])))
    rty = np.arcsinh(data_y-data_y[0]+1.0)    
    ...
    temp = 353.0
    dat = np.loadtxt('pep_t_350_new.txt',delimiter=',')
    field = np.reshape(dat[:,0],(len(dat[:,0])))
    data_y = np.reshape(dat[:,1],(len(dat[:,1])))
    rty = np.arcsinh(data_y-data_y[0]+1.0)    
