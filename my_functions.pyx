...
class rotational_relaxation:
    ...
    def __init__(self,aniso_dipolar,g1_iso,g2_iso,aniso_g1,aniso_g2,iso_h1,iso_h2,aniso_hyperfine_1,aniso_hyperfine_2,spin_numbers_1,spin_numbers_2,field,J,dj,ks,kt,exchange_rate,lamb,temp):
        ...
        """ cdef double self.r_perp
        cdef double self.r_parr
        cdef double  self.prefact
        cdef double self.beta 
        cdef double self.c 
        cdef double self.visc
        cdef double self.convert
        cdef double self.d_perp
        cdef double self.d_parr
        cdef double self.lamb
        cdef double
        cdef double
        cdef double
        cdef double
    ...
    def Redfield_Matrix(self):
        ...
        cdef double[32,32] self.red
        cdef double[32,] self.lam
        cdef double[32,32] self.p
        cdef double[32,32] self.pinv
        cdef double[32,32] self.B
        cdef double[32,32] self.Bmn
        cdef double[4,4] self.qmn
        cdef double[4,4] self.iden4
        cdef double[16,16] self.amn
        cdef double[5, 5, 4, 4] self.dipolar_tensor_product
        cdef double[5, 5, 4, 4] self.elec_1
        cdef double[5, 5, 4, 4] self.elec_2
        cdef double[32,32] self.jw_n
        cdef double[32,32] self.elem_wise
        cdef double self.tauc_n
        cdef double self.r_perp
        cdef double self.r_parr
        cdef int i
        cdef int j
