...
data = np.loadtxt('fn1_exnl.txt',delimiter=',')
data_loc = np.loadtxt('fn1_local_min.txt',delimiter=',')
data_no_kstd = np.loadtxt('fn1_no_kstd.txt',delimiter=',')
...
#plt.plot(1.0/data_no_kstd[:,4],np.log(data_no_kstd[:,1]*(1.76e8)*np.sqrt(data_no_kstd[:,4])),'o--',label = 'ks no kstd')
plt.plot(1.0/data_no_kstd[:,4],np.log(data_no_kstd[:,2]*(1.76e8)*np.sqrt(data_no_kstd[:,4])),'o--',label = 'kt no kstd')
...
plt.plot(data_no_kstd[:,4],data_no_kstd[:,1],'o--',label = 'ks no kstd loc')
plt.plot(data_no_kstd[:,4],data_no_kstd[:,2],'o--',label = 'kt no kstd loc')
...
plt.plot(data_no_kstd[:,4],data_no_kstd[:,0],'^--',label = 'Initial triplet population no kstd loc')
