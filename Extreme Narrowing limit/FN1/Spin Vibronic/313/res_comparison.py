...
no_lamb_dat = np.loadtxt("fn1_313.0_no_lamb_yield.txt",delimiter=',') 
full_dat = np.loadtxt('fn1_313.0_yield.txt',delimiter=',')
...
plt.clf()
plt.plot(np.array([0.0,2.0*J,120.0]),np.array([4.223719001138495,1.3593913081127948,4.649690269230726]),'^--',label = 'Experimental')
plt.plot(np.array([0.0,2.0*J,120.0]),np.array([4.470602112058322,1.6817217157090274,4.787791838991248]),'o--', label = 'Full simulation')
plt.plot(np.array([0.0,2.0*J,120.0]),np.array([4.311303932000868,2.26729114210577,4.7514986022552685]),'o--',label = 'No Lambda')
